...
module.exports = (err, req, res, next) => {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    // this error is generated by the JWT verify function in authController in the protect middleware
    if (error.name === 'JsonWebTokenError') error = handleJwtError();

    // this error happens if the token expiration time has ended
